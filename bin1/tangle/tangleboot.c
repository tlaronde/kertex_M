int argc;
char **argv;
#define fputs_(stream, s)	fputs(s, stream) /* fixwrites */
...
{integer j  ; 
  ...
  {
    if ( changing ) 
    (void) fputs_( stdout ,  ". (change file " ) ; 
    else
    (void) fputs_( stdout ,  ". (" ) ; 
...
{integer dotpos, seppos, i, a  ; 
  ...
  do 
	...
	if ( ! foundweb ) 
	{
	  ...
	  seppos = -1 ; 
	  i = 1 ; 
	  while ( ( nameoffile [ i ] != ' ' ) && ( nameoffile [ i ] != 0 ) && 
	  ( i <= FILENAMEMAX - 5 ) ) {
	  ...
	  if ( dotpos == -1 ) 
	  {
	    dotpos = i ; 
	    nameoffile [ dotpos ] = '.' ; 
	    nameoffile [ dotpos + 1 ] = 'w' ; 
	    nameoffile [ dotpos + 2 ] = 'e' ; 
	    nameoffile [ dotpos + 3 ] = 'b' ; 
	    nameoffile [ dotpos + 4 ] = 0 ; 
	  } 
	  reset ( webfile , nameoffile ) ; 
	  if ( seppos == -1 ) 
	  seppos = 0 ; 
	  nameoffile [ seppos ] = ' ' ; 
	  nameoffile [ dotpos + 1 ] = 'p' ; 
	  nameoffile [ dotpos + 2 ] = 0 ; 
	  rewrite ( Pascalfile , nameoffile + seppos ) ; 
	  nameoffile [ dotpos + 1 ] = 'p' ; 
	  nameoffile [ dotpos + 2 ] = 'o' ; 
	  nameoffile [ dotpos + 3 ] = 'o' ; 
	  nameoffile [ dotpos + 4 ] = 'l' ; 
	  nameoffile [ dotpos + 5 ] = 0 ; 
	  rewrite ( pool , nameoffile + seppos ) ; 
	  foundweb = true ; 
	} 
	else if ( ! foundchange ) 
	{
	  ...
	  if ( dotpos == -1 ) 
	  {
	    dotpos = i ; 
	    nameoffile [ dotpos ] = '.' ; 
	    nameoffile [ dotpos + 1 ] = 'c' ; 
	    nameoffile [ dotpos + 2 ] = 'h' ; 
	    nameoffile [ dotpos + 3 ] = 0 ; 
	  } 
	  reset ( changefile , nameoffile ) ; 
	  foundchange = true ; 
	} 
	else {
...
{register boolean Result; integer finallimit  ; 
  ...
  Result = false ; 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Input line too long" ) ; 
	} 
	loc = 0 ; 
	error () ; 
      } 
...
{/* 31 32 */ register namepointer Result; eightbits c  ; 
  ...
  if ( ( p == nameptr ) || ( t != 0 ) ) 
  {
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! This identifier has already appeared" ) ; 
	  error () ; 
	} 
	q = chophash [ h ] ; 
	if ( q == p ) 
	...
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! This identifier was defined before" ) ; 
	error () ; 
      } 
      ilk [ p ] = t ; 
    } 
	...
	while ( q != 0 ) {
	    
	  {
	    ...
	    {
	      (void) putc('\n',  stdout );
	      (void) fputs_( stdout ,  "! Identifier conflict with " ) ; 
	    } 
	...
	equiv [ p ] = buffer [ idfirst + 1 ] + 32768L ; 
	  ...
	  {
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! Preprocessed string is too long" ) ; 
	    error () ; 
	  } 
	  incr ( stringptr ) ; 
...
{/* 31 */ register namepointer Result; signed char c  ; 
  integer j  ; 
  integer k  ; 
  signed char w  ; 
  namepointer p  ; 
  ...
  lab31: if ( c != 1 ) 
  {
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "! Incompatible section names" ) ; 
      error () ; 
    } 
    p = 0 ; 
  } 
...
{register namepointer Result; signed char c  ; 
  integer count  ; 
  integer j  ; 
  integer k  ; 
  signed char w  ; 
  ...
  {
    (void) putc('\n',  stdout );
    (void) fputs_( stdout ,  "! Name does not match" ) ; 
    error () ; 
  } 
  else {
      
    (void) putc('\n',  stdout );
    (void) fputs_( stdout ,  "! Ambiguous prefix" ) ; 
    error () ; 
  } 
  Result = r ; 
  return(Result) ; 
...
{/* 20 30 31 */ register sixteenbits Result; sixteenbits a  ; 
  ...
  if ( a < 10240 ) 
  {
	...
	) ) 
	{
	  {
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! No parameter given for " ) ; 
	  } 
	  printid ( a ) ; 
	  error () ; 
	  goto lab20 ; 
  ...
  if ( a < 20480 ) 
  {
    ...
    else if ( a != 0 ) 
    {
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Not present: <" ) ; 
      } 
      printid ( a ) ; 
      (void) putc( '>' ,  stdout );
      error () ; 
...
{integer k  ; 
  ...
  if ( outptr > linelength ) 
  {
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "! Long line must be truncated" ) ; 
      error () ; 
    } 
    outptr = linelength ; 
  } 
  ...
  case 3 : 
    {
      ...
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Two numbers occurred without a sign between them"         ) ; 
...
{/* 2 21 22 */ eightbits curchar  ; 
  ...
  while ( stackptr > 0 ) {
	...
	do {
	  ...
	  {
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! Constant too big" ) ; 
	    error () ; 
	  } 
	  else n = 10 * n + curchar ; 
	  curchar = getoutput () ; 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! String too long" ) ; 
	  error () ; 
	} 
	sendout ( 1 , k ) ; 
	curchar = getoutput () ; 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Verbatim string too long" ) ; 
	  error () ; 
	} 
	sendout ( 1 , k - 1 ) ; 
      } 
    ...
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "! Fraction too long" ) ; 
      error () ; 
    } 
    sendout ( 3 , k ) ; 
    goto lab21 ; 
...
{/* 22 30 10 */ integer k  ; 
  ...
  while ( true ) {
    ...
    if ( ( buffer [ 1 ] == 121 ) || ( buffer [ 1 ] == 122 ) ) 
    {
      ...
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Where is the matching @x?" ) ; 
	error () ; 
      } 
    } 
    lab22: ; 
  ...
  do {
    ...
    if ( ! inputln ( changefile ) ) 
    {
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Change file ended after @x" ) ; 
	error () ; 
      } 
      goto lab10 ; 
    } 
...
{/* 10 */ integer n  ; 
  ...
  while ( true ) {
    ...
    if ( ! inputln ( changefile ) ) 
    {
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Change file ended before @y" ) ; 
	error () ; 
      } 
      changelimit = 0 ; 
      changing = ! changing ; 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Where is the matching @y?" ) ; 
	  error () ; 
	} 
      } 
    ...
    if ( ! inputln ( webfile ) ) 
    {
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! WEB file ended during a change" ) ; 
	error () ; 
      } 
      inputhasended = true ; 
      goto lab10 ; 
...
{/* 20 */ lab20: if ( changing ) 
  {
    ...
    if ( ! inputln ( changefile ) ) 
    {
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Change file ended without @z" ) ; 
	error () ; 
      } 
      buffer [ 0 ] = 64 ; 
      buffer [ 1 ] = 122 ; 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Where is the matching @z?" ) ; 
	  error () ; 
	} 
      } 
...
{/* 10 */ eightbits bal  ; 
  ...
  while ( true ) {
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Input ended in mid-comment" ) ; 
	  error () ; 
	} 
	goto lab10 ; 
      } 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Section ended in mid-comment" ) ; 
	  error () ; 
	} 
	decr ( loc ) ; 
	goto lab10 ; 
...
{/* 20 30 31 */ register eightbits Result; eightbits c  ; 
  ...
  case 34 : 
	...
	if ( buffer [ loc ] == d ) 
	{
	  ...
	  {
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! Double @ sign missing" ) ; 
	    error () ; 
	  } 
	} 
	else if ( loc > limit ) 
	{
	  {
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! String constant didn't end" ) ; 
	    error () ; 
	  } 
	  d = 34 ; 
	} 
  ...
  case 64 : 
	...
	while ( true ) {
	  ...
	  if ( loc > limit ) 
	  {
	    ...
	    if ( inputhasended ) 
	    {
	      {
		(void) putc('\n',  stdout );
		(void) fputs_( stdout ,  "! Input ended in section name" ) ; 
		error () ; 
	      } 
	      goto lab30 ; 
	    } 
	  ...
	  if ( d == 64 ) 
	  {
	    ...
	    if ( ( d == 32 ) || ( d == 9 ) || ( d == 42 ) ) 
	    {
	      {
		(void) putc('\n',  stdout );
		(void) fputs_( stdout ,  "! Section name didn't end" ) ; 
		error () ; 
	      } 
	      goto lab30 ; 
	    } 
	...
	lab30: if ( k >= longestname - 2 ) 
	{
	  {
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! Section name too long: " ) ; 
	  } 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Improper @ within control text" ) ; 
	  error () ; 
	} 
	goto lab20 ; 
      } 
...
{/* 21 30 */ integer accumulator  ; 
  ...
  while ( true ) {
    ...
    case 59 : 
      {
	(void) putc('\n',  stdout );
	(void) fputs_( stdout ,  "! Omit semicolon in numeric definition" ) ; 
	error () ; 
      } 
      break ; 
      default: 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Improper numeric definition will be flushed" ) ; 
	  error () ; 
	} 
	do {
  ...
  while ( true ) {
	...
	while ( true ) {
	  ...
	  incr ( loc ) ; 
	    ...
	    (void) putc('\n',  stdout );
	    (void) fputs_( stdout ,  "! You should double @ signs in strings" ) ; 
	    error () ; 
	  } 
	  if ( loc == limit ) 
	  {
	    {
	      (void) putc('\n',  stdout );
	      (void) fputs_( stdout ,  "! String didn't end" ) ; 
	      error () ; 
	    } 
	    buffer [ loc ] = 39 ; 
	    buffer [ loc + 1 ] = 0 ; 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Verbatim string didn't end" ) ; 
	  error () ; 
	} 
	else if ( buffer [ loc + 1 ] != 62 ) 
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! You should double @ signs in verbatim strings" ) 
	  ; 
	  error () ; 
	} 
	loc = loc + 2 ; 
...
{/* 22 30 10 */ namepointer p  ; 
  ...
  while ( true ) {
	...
	if ( nextcontrol == 41 ) 
	{
	  ...
	  if ( nextcontrol == 61 ) 
	  {
	    {
	      (void) putc('\n',  stdout );
	      (void) fputs_( stdout ,  "! Use == for macros" ) ; 
	      error () ; 
	    } 
	    nextcontrol = 30 ; 
	  } 
    ...
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "! Definition flushed since it starts badly" ) ; 
      error () ; 
    } 
  } 
  lab30: ; 
  ...
  case 135 : 
	...
	{
	  (void) putc('\n',  stdout );
	  (void) fputs_( stdout ,  "! Pascal text flushed, = sign is missing" ) ; 
	  error () ; 
	} 
	do {
	    nextcontrol = skipahead () ; 
...
main(int argc_, char *argv_[])
{
  ...
  if ( changelimit != 0 ) 
  {
    ...
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "! Change file entry did not match" ) ; 
      error () ; 
    } 
  } 
  phaseone = false ; 
  if ( textlink [ 0 ] == 0 ) 
  {
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "! No output was specified." ) ; 
    } 
    if ( history == 0 ) 
    history = 1 ; 
  } 
    ...
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "Writing the output file" ) ; 
    } 
    hbreak ( stdout ) ; 
    stackptr = 1 ; 
    bracelevel = 0 ; 
  ...
  {case 0 : 
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "(No errors were found.)" ) ; 
    } 
    break ; 
  case 1 : 
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "(Did you see the warning message above?)" ) ; 
    } 
    break ; 
  case 2 : 
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "(Pardon me, but I think I spotted something wrong.)" ) 
      ; 
    } 
    break ; 
  case 3 : 
    {
      (void) putc('\n',  stdout );
      (void) fputs_( stdout ,  "(That was a fatal error, my friend.)" ) ; 
    } 
    break ; 
  } 
  (void) putc('\n',  stdout );
